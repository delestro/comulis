...
function getBiseDataSegmentation(tableid) {

  ajaxGet(
        json_url_segmentation,
        function (response) {
...
<a class="sqs-block-button-element--medium sqs-block-button-element" target="_blank" data-initialized="true" onclick="getBiseDataSegmentation('biiitab')">List segmentation software<br>from biii.eu</a>
</div></div></div>

...
function getBiseDataRegistration(tableid) {

  ajaxGet(
        json_url_registration,
        function (response) {
...
<a class="sqs-block-button-element--medium sqs-block-button-element" target="_blank" data-initialized="true" onclick="getBiseDataRegistration('biiitab')">List registration software<br>from biii.eu</a>
</div></div></div>
